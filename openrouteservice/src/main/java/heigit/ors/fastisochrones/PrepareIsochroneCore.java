...
import heigit.ors.routing.graphhopper.extensions.core.AbstractCoreRoutingAlgorithm;
import heigit.ors.routing.graphhopper.extensions.core.CoreDijkstra;
...
public class PrepareIsochroneCore extends AbstractAlgoPreparation implements RoutingAlgorithmFactory {
    ...
    PrepareIsochroneCore(Directory dir, GraphHopperStorage ghStorage, CHGraph chGraph, Weighting weighting, TraversalMode traversalMode, EdgeFilter restrictionFilter) {
        this.dir = dir;
